...
<div class = "details-container">
  <details>
    <summary>Game Design und Entwicklung, frühe Erfahrungen mit Computerspielen, Minecraft-Modifikationen, Redstone-Schaltungen, Level-Design und Spielmodifikationen</summary>
    - Interesse an Computerspielen von klein auf<br>
    - Design eigener Level für Super Mario<br>
    - Minecraft-Redstone-Schaltungen<br>
    - Erste Schritte im Gamedesign<br>
    - Modifikationen und Ressourcenpakete in Minecraft<br>
  ...
  <details>
      <summary>3D-Modellierung und erste Programmierschritte, Text-Games, Grafikbearbeitung, Batch-Programmierung und erste Erfahrungen mit GIMP</summary>
      - Interesse an 3D-Modellierung mit Google SketchUp und Sculpt3D<br>
      - Erste Programmierversuche mit Batch und Windows Editor<br>
      - Leuchtturm-Projekt mit Fischer-Technik<br>
      - Zeichentrick-Animationen und Stop-Motion<br>
      - Einstieg in die grafische Bildbearbeitung mit GIMP<br>
      <strong>KLICKEN</strong><br>
  ...
  <details>
      <summary>TypeScript, Programmierung und Processing, erste Erfahrungen mit künstlicher Intelligenz und Bildverarbeitung</summary>
      - Umstieg auf TypeScript für dynamische Bilderzeugung<br>
      - Erste Erfahrungen mit Processing und Pong-Programmierung<br>
      - Interesse an digitaler Medienerstellung<br>
      - Erste Berührung mit künstlicher Intelligenz und Echtzeit-Bildverarbeitung<br>
      <strong>KLICKEN</strong><br>
  ...
  <details>
      <summary>Mathematik in der Programmierung, neuronale Netzwerke, fraktale Geometrie und künstliche Intelligenz</summary>
      - Interesse an Vektorrechnung und fraktaler Geometrie<br>
      - Programmierung neuronaler Netzwerke für künstliche Intelligenz<br>
      - Erste formale Ausbildung in Informatik<br>
      - Experimentelle Programmierung für verschiedene Fächer<br>
      <strong>KLICKEN</strong><br>
  ...
  <details>
      <summary>Java-Entwicklungen, Kalender, Game-Of-Life, Tic-Tac-Toe mit KI</summary>
      - Entwicklung eines ewigen Kalenders und von Game-Of-Life in Java<br>
      - Umsetzung eines Tic-Tac-Toe-Spiels mit KI<br>
      - Erste Erfahrungen in der Softwareentwicklung im Studium<br>
      <strong>KLICKEN</strong><br>
  ...
  <details>
      <summary>GlobalGameJam 2020, VR-Spielentwicklung, Gamedesign und Sounddesign</summary>
      - Mitwirkung in einem Team bei der Entwicklung eines VR-Spiels<br>
      - Hauptaufgaben in Gamedesign und Sounddesign<br>
      - Interesse an 3D-Programmierung und 3D-Modellierung<br>
      - Weiterentwicklung in Unity und Blender<br>
      <strong>KLICKEN</strong><br>
  ...
  <details>
      <summary>Studium der Medieninformatik, Tutorentätigkeit, Praktikum und Werkstudentenstelle</summary>
      - Studium der Medieninformatik an der Hochschule Furtwangen<br>
      - Tutorentätigkeit in Mathematik und Informatik<br>
      - Praktikum bei Weltenbauer Software Entwicklung GmbH<br>
      - Weiterbeschäftigung als Werkstudent und Projektstudium<br>
      - Entwicklung erfolgreicher Spiele im Team<br>
      <strong>KLICKEN</strong><br>
...
Puzzle-Games und Aufbau-Strategiespiele sowie Cozy Games, Simulatoren oder Musik-/Sound- und Rhythm-Games kommen besonders in Frage.  
